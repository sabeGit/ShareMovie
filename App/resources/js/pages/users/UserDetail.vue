            ...
            <div class="col-sm-3 hidden-xs">
                ...
                <div class="sidebar">
                    <div class="list-group">
                        <RouterLink v-bind:to="{ name: 'UserDetail', params: { username: username, option: 'post' }}" class="list-group-item post" v-bind:class="{ active: selectItem === 'post' }">
                            コメント
                        </RouterLink>
                        <RouterLink v-bind:to="{ name: 'UserDetail', params: { username: username, option: 'rating' }}" class="list-group-item rating" v-bind:class="{ active: selectItem === 'rating' }">
                            レビュー
                        </RouterLink>
                        <RouterLink v-bind:to="{ name: 'UserDetail', params: { username: username, option: 'favorite' }}" class="list-group-item favorite" v-bind:class="{ active: selectItem === 'favorite' }">
                            お気に入り
                        </RouterLink>
                        <RouterLink v-bind:to="{ name: 'UserDetail', params: { username: username, option: 'watched' }}" class="list-group-item watched" v-bind:class="{ active: selectItem === 'watched' }">
                            視聴済み
                        </RouterLink>
                    </div>
                </div>
